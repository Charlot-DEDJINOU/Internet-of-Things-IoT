...
const String serverUrl = "http://192.168.17.77:8000/system/validate/entry/"; // Exemple d'URL
...
void loop() {
  ...
  if (key) {
    ...
    if (key == '*') {
      ...
      lcd.clear();
      lcd.print("Entrez code:");
      return; // On quitte la boucle pour éviter une mise à jour supplémentaire
    }
    else if (key == '#') {
